    ...
    <main className="hero">
      ...
      <div className="hero-content">
        ...
        <div className="hero-links">
          <a href="#contact" className="magnetic-link">
            <span className="link-text">DISCUSS YOUR PROJECT</span>
            <span className="link-arrow">→</span>
          </a>
          <a href="#contact" className="magnetic-link">
            <span className="link-text">BOOK A 30-MINUTE CALL</span>
            <span className="link-arrow">→</span>
          </a>
        </div>
      </div>
      ...
      <div className="hero-info">
        <div className="established">
          ...
          <div className="established-copy">
            <strong>14+ YEARS SHAPING</strong>
            <strong>DIGITAL DIRECTION.</strong>
          </div>
        </div>
        <p>
          Websites, AI products, brands, and systems built for clarity, scale
          and impact.
        </p>
      </div>
      {/* =================================================
      ...
      <div className="hero-bottom-text">
        ...
        <span>BLAST</span>
        <br />
        <span>DARE ⚡ TO TOUCH THE LINES.</span>
      </div>
      {/* =================================================
          SCROLL
      ================================================= */}
