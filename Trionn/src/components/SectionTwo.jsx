  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      /* =====================================================
         TEXT LETTERS
      ===================================================== */
      const letters = text.querySelectorAll(".about-letter");
    ...
    <section ref={sectionRef} className="about-section" id="about">
      ...
      <div className="about-intro">
        ...
        {/* =================================================
            BIG STATEMENT
        ================================================= */}
        <div ref={textRef} className="about-statement" aria-label={statement}>
          {statement.split("").map((character, index) => (
            <span
              key={`${character}-${index}`}
              className={
                character === " " ? "about-letter about-space" : "about-letter"
              }
              aria-hidden="true"
            >
              {character === " " ? "\u00A0" : character}
