...
export default function KeyFacts() {
    ...
    const ctx = gsap.context(() => {
      ...
      const tl = gsap.timeline({
        scrollTrigger: {
          ...
          /*
            Mobile needs a little more scroll distance
            because cards are shown one by one.
          */
          end: isMobile ? "+=3900" : "+=3300",
  ...
  useEffect(() => {
    ...
    const updateNavbarColor = () => {
      ...
      navbar.classList.remove(
        "keyfacts-navbar-dark",
        "keyfacts-navbar-light"
      );
  ...
  useEffect(() => {
    ...
    const xray =
      card.querySelector(".keyfacts-xray");
    ...
    const scanMask = () => {
      ...
      const maskLeft =
        videoRect.left +
        videoRect.width * 0.29;

      const maskRight =
        videoRect.left +
        videoRect.width * 0.71;

      const maskTop =
        videoRect.top +
        videoRect.height * 0.02;

      const maskBottom =
        videoRect.top +
        videoRect.height * 0.54;
    ...
    <>
      ...
      >
        ...
        <div className="keyfacts-stage">
          <div className="keyfacts-cards">
            ...
            <article
              ref={leftCardRef}
              className="keyfacts-card keyfacts-card-left"
            >
              <video
                ref={leftVideoRef}
              ...
              <div className="keyfacts-card-title">
                FEATURED &amp; AWARDS
              </div>
                ...
                {awardImages.map(
                  (image, index) => (
                    <img
                      ...
                      src={image}
                      alt=""
                      className={`keyfacts-award-image ${
                        index === 0
                          ? "is-active"
                          : ""
                      }`}
            ...
            <article
              ref={centerCardRef}
              className="keyfacts-card keyfacts-card-center"
            >
              <div className="keyfacts-card-title">
                PROJECTS COMPLETED
              </div>
            ...
            <article
              ref={rightCardRef}
              className="keyfacts-card keyfacts-card-right"
            >
              <div className="keyfacts-card-title">
                OUR TEAM MEMBERS
              </div>
      ...
      <section className="business-partners-section">
        <div className="business-partners-inner">
          ...
          <div className="business-partners-title">
            OUR BUSINESS PARTNERS
          </div>

          <div className="business-partners-row">

            <div className="partner-credible">
              credible
            </div>

            <div className="partner-yellowtail">
              Yellowtail
            </div>

            <div className="partner-luxury">
              <span className="luxury-symbol">
                ϕ
              </span>
            ...
            <div className="partner-technis">
              technis
            </div>

            <div className="partner-ockto">
              <span className="ockto-symbol">
                ⬡
              </span>
